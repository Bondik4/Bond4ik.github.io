...
export default function Footer() {
  return (
    <footer
      ...
      {/* <!-- Основной контейнер div: содержит все содержимое нижнего колонтитула, включая четыре раздела (элементы TW, Продукты, полезные ссылки и контакты), с адаптивным дизайном и соответствующими отступами/ полями. --> */}
        ...
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mb-4 flex items-center justify-center md:justify-start">
              ...
              ул. Руставели, 33, Санкт-Петербург
            </p>
            <p className="mb-4 flex items-center justify-center md:justify-start">
              <svg
                xmlns="http://www.w3.org/2000/svg"
