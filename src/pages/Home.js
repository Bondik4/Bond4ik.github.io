...
function Home() {
  ...
  return (
    <>
      ...
      {burgerIsOpen
        && (<div id='burger-modal' onClick={closeBurgerClick} className='flex justify-center items-center w-[100vw] h-[100vh] fixed bg-indigo-500/50 top-0 left-0 z-20'>
          <div className='p-28 flex bg-white'>
            123
          </div>
        </div>)}
      {/* Main */}
