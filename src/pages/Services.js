          ...
          <div className="container mx-auto">
            ...
            <div className="flex flex-col md:flex-row pt-12 gap-[70px] pl-[7px] pr-[7px]">
              <div className="relative">
                ...
                <div className="absolute text-white bottom-0 right-0 z-10 p-2 md:p-0 lg:p-2 border rounded-full mb-3 mr-3 stroke-[White] hover:bg-white hover:stroke-[#91036d] duration-[90ms]">
